 ...
 * specified in the context. Also cleans the memory using argon2_clear_internal_memory.
...
/* We don't need these for a cracker */
#if 1
#define argon2_secure_wipe_memory(...)
#define argon2_clear_internal_memory(...)
#else
/* Function that securely cleans the memory. This ignores any flags set
 * regarding clearing memory. Usually one just calls argon2_clear_internal_memory.
 * @param mem Pointer to the memory
 * @param s Memory size in bytes
 */
void argon2_secure_wipe_memory(void *v, size_t n);
